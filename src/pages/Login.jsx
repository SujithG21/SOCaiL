    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `http://localhost:3001/${isRegistering ? 'register' : 'login'}`,
                {
                    email,
                    password,
                    rememberMe,
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-purple-50 relative overflow-hidden">
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen">
                <div className="max-w-md w-full bg-white rounded-lg border-2 border-indigo-500/35 hover:shadow-indigo-500/50 hover:shadow-lg transition-shadow duration-300">
                    <div className="p-6">
